...
const menuItems = [
  { id: 1, icon: <FaTv />, label: "Overview", notifications: 0 },
  { id: 2, icon: <FaBook />, label: "Courses", notifications: 0 },
  { id: 3, icon: <FaCalendarAlt />, label: "Schedule", notifications: 2 },
  { id: 4, icon: <FaComments />, label: "Discussion", notifications: 0 },
  { id: 5, icon: <FaFire />, label: "Leaderboard", notifications: 0 },
...
function SideNav() {
  ...
  return (
    <ul className="flex flex-col  gap-3 h-screen  w-fit p-1 pl-3 pr-0  bg-secondary justify-between">
