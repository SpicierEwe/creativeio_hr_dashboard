        ...
        {coursesData.map((course) => (
          <div className=" rounded-2xl flex flex-col md:flex-row   items-center gap-4 text-start ">
            ...
            <div className=" flex flex-col md:flex-row md:w-[40%]  gap-3  ">
              <div className="w-11 md:w-44">
                <img src="https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.jpg" />
              </div>
              <div className="flex flex-col gap-2">
                <h2 className="text-md">{course.title}</h2>
                <p className="text-sm">{course.description}</p>
                <div className="mt-3 flex items-center gap-x-5 gap-y-2 text-xs text-primary flex-wrap">
                  ...
                  {/* person */}
                  <div className="flex items-center   md:mt-10  justify-start  self-start md:w-[20%]  gap-2.5 ">
                    <MdPerson />
                    <h2>by Rose Poole</h2>
                  </div>
                </div>
