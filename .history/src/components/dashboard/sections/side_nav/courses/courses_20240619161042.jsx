...
const Courses = () => {
  return (
    <div className="p-6 bg-green-100 items-start">
      ...
      <div className="space-y-4">
        {coursesData.map((course) => (
          <div
            key={course.id}
            className="flex flex-col md:flex-row items-start gap-5 justify-between p-4 bg-white rounded-lg shadow-md"
          >
            {/* container 2 */}
            <div className="flex flex-col md:flex-row items-center space-x-4 bg-purple-100">
