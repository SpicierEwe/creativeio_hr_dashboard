...
const Courses = () => {
  return (
    <div className="p-5 mt-7 flex flex-col items-start bg-white rounded-xl">
      ...
      <div className="mt-10 w-full flex flex-col gap-10 md:w-[70%]">
        {coursesData.map((course) => (
          <div className=" rounded-2xl flex flex-col md:flex-row   items-center gap-4 text-start  ">
            {/* container 1 === */}
            <div className=" flex flex-col md:flex-row md:items-center w-[70%] gap-3 md:gap-7 bg-green-500  ">
              ...
              <div className="flex flex-col gap-2 ">
                ...
                {/* bottom */}
                <div className="mt-3 md:mt-0 md:justify-between whitespace-nowrap flex items-center min-w-full bg-red-100 gap-x-5 gap-y-2 text-xs text-primary flex-wrap">
