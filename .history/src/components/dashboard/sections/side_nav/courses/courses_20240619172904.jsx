...
const Courses = () => {
  return (
    <div className="p-5 mt-7 flex flex-col items-start bg-white rounded-xl">
      ...
      <div className="mt-10 w-full flex flex-col gap-10 md:w-[100%]">
        {coursesData.map((course) => (
          <div className=" rounded-2xl flex flex-col md:flex-row   items-center gap-4 text-start justify-between  ">
            {/* container 1 === */}
            <div className=" flex flex-col md:flex-row md:items-center md:w-[50%] gap-3 md:gap-7  ">
            ...
            <div className="text-left bg-red-200 w-full md:w-fit pl-3">
