...
const menuItems = [
  { id: 1, icon: <FaHome />, label: "Overview", notifications: 5 },
  { id: 2, icon: <FaInfoCircle />, label: "Courses", notifications: 4 },
  { id: 3, icon: <FaChartBar />, label: "Schedule", notifications: 2 },
  { id: 4, icon: <FaComments />, label: "Discussion", notifications: 1 },
  { id: 5, icon: <FaTrophy />, label: "Leaderboard", notifications: 7 },
