...
function Reminder() {
  return (
    <div>
      {/* container 1 */}
      <div className="mt-5 p-5 rounded-2xl flex flex-col lg:items-center lg:flex-row gap-4 text-start bg-white">
        {/* container 1 === */}
        <div className=" flex flex-col lg:flex-row lg:items-center lg:w-[40%]  gap-3 gap-x-5   ">
          <div className="w-14">
