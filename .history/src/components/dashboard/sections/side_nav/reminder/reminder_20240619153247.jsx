...
function Reminder() {
  return (
    <div>
      {/* container 1 */}
      <div className="mt-5 p-5 rounded-2xl flex flex-col md:flex-row  items-start justify-evenly gap-4 text-start bg-white">
        <div className="w-11">
        ...
        <div className="flex items-center flex-col gap-1.5  w-full bg-red-500">
