  ...
  return (
    <div>
      ...
      <div className="mt-5 p-5 rounded-2xl flex flex-col md:flex-row   items-start gap-4 text-start bg-white">
        {/* container 1 === */}
        <div className=" flex flex-col md:flex-row md:w-[50%]  gap-3 bg-red-400 ">
          <div className="w-11">
        ...
        {/* container 2===== */}
        <div className="flex items-center justify-end md:w-[20%]  gap-2.5 text-xs bg-green-300">
          <MdPerson />
          <p>by Rose Poole</p>
        </div>

        {/* container 3 ===== */}
        <div className="flex items-end  justify-end md:w-[30%] flex-col gap-1.5  bg-purple-500">
