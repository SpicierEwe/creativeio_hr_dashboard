  ...
  return (
    <div>
      ...
      <div className="mt-5 p-5 rounded-2xl flex flex-col md:flex-row   items-center gap-4 text-start bg-white">
        ...
        {/* container 2===== */}
        <div className="flex items-center md:items-end md:mt-10  justify-start  md:justify-start md:w-[20%]  gap-2.5 text-xs ">
          <MdPerson />
          <p>by Rose Poole</p>
        </div>

        {/* container 3 ===== */}
        <div className="flex items-end self-start md:self-end   md:w-[30%]  flex-col gap-1.5  ">
