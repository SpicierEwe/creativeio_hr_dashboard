function Section2() {
  ...
  return (
    <div>
      <div className="flex flex-col gap-5 bg-white px-5 py-10 shadow-lg">
        {data.map((item) => (
          <div>
            <h2 className="text-start">{item.title}</h2>
            <ul className="mt-5 grid grid-cols-4 items-center flex-wrap">
              {item.content.map((subItem, index) => (
                <li key={subItem.id} className="flex items-center">
                  ...
                  <div className="text-start">
                    <h2 className="font-medium">{subItem.title}</h2>
