...
function Section1() {
  ...
  return (
    <div className="no-scrollbar flex gap-5 overflow-x-auto hide-scroll w-full pr-20 p-5 pt-7 pl-9 xl:grid grid-cols-4 xl:pr-5">
      {data.map((item, index) => {
        return (
          <div
            key={index}
          ...
          >
            ...
            <div className="text-lg font-medium mb-2 whitespace-nowrap">
              {item.title}
            </div>
