...
function Section1() {
  ...
  return (
    <div className="flex gap-5 overflow-x-auto hide-scroll w-full pr-20 p-5 pt-7 pl-9 xl:grid grid-cols-4 xl:pr-5">
      {data.map((item, index) => {
        return (
          <div
            key={index}
            className="text-start rounded-3xl p-5 px-10 pl-5 bg-primary flex flex-col items-start"
            style={{
