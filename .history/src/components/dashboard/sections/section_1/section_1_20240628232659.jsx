...
function Section1() {
  ...
  return (
    <div className="hide-scrollbar flex gap-5 lg:gap-10 overflow-x-auto hide-scroll w-full p-5 pl-0   xl:grid grid-cols-4">
      {data.map((item, index) => {
        return (
          <div
            key={index}
            ...
            } transition-all duration-200 ease-in-out  ml-[5rem] lg:ml-[15rem] bg-red-500`}
            style={{
              border: `2px ${
