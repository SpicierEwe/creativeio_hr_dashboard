...
function Section1() {
  ...
  return (
    <div className="hide-scrollbar flex gap-5 overflow-x-auto hide-scroll w-full p-5 pt-7 pl-9 xl:grid grid-cols-4 xl:pr-5">
      {data.map((item, index) => {
        return (
          <div
            key={index}
          ...
          >
            ...
            <div className="flex flex-col md:flex-row mt-1.5 items-center">
              ...
              <div className="flex gap-1 items-center mt-3 bg-[#ebf9ee] text-[#31c656] w-fit rounded-xl py-1 px-2 md:gap-2">
                <RiArrowUpSFill />
