        ...
        {data.map((item, index) => {
          return (
            <div
              ...
              className={`text-start  p-5 bg-primary flex flex-row items-center gap-5 text-white cursor-pointer ${
                selectedIndex === index ? `shadow-md scale-x-150` : ""
            ...
            >
              <div className="">
                <img src={`/images/section-1/icons/${index + 1}.svg`} />
              </div>
