...
function Section1() {
  ...
  return (
    <div className="hide-scrollbar flex gap-5 lg:gap-10 overflow-x-auto hide-scroll w-full p-5 pl-10  xl:grid grid-cols-4 xl:pr-10">
      {data.map((item, index) => {
        return (
          <div
            key={index}
          ...
          >
            ...
            <div className="w-full flex gap-3 mt-2  items-center justify-between">
              ...
              <div className="flex gap-1 items-center text-[#31c656] w-fit rounded-xl py-1 px-2">
                {!item.drop ? (
