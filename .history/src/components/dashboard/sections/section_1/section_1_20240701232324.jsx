...
function Section1() {
  const data = [
    {
      icon: <PiCircleNotchDuotone size={35} />,
      title: "Total Cost",
      count: "$15000",
      percentage: "24%",
  ...
  return (
    <div className="hide-scrollbar flex gap-5 overflow-x-auto hide-scroll w-full p-5    xl:grid grid-cols-5  pl-[5rem] lg:pl-[15rem]">
      {data.map((item, index) => {
        return (
          <div
            key={index}
