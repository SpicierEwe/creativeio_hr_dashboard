  ...
  return (
    <div className=" pl-[5rem] lg:pl-[15rem]">
      ...
      <div className="flex flex-col xl:flex-row items-start gap-5 w-full ">
        ...
        <div className="flex items-start flex-col xl:flex-row gap-5 text-xs">
          <button className="border-2 border-[#dadce5] px-4 py-3 rounded-lg">
            + Manage dashboard
          </button>
          <button className="border-2 border-[#dadce5] px-4 py-3 rounded-lg text-[ff814a]">
