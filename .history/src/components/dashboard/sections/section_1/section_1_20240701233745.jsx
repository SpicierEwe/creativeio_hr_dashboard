  ...
  return (
    <div className=" pl-[5rem] lg:pl-[15rem]">
      ...
      <div className="flex flex-col xl:flex-row items-start xl:justify-between gap-5 w-full ">
        ...
        <div className="flex items-start flex-col xl:flex-row gap-5 text-xs xl:text-md">
          <button className="border border-[#dadce5] px-4 py-3 rounded-lg">
            + Manage dashboard
          </button>
          <button className=" px-4 py-3 rounded-lg bg-[#ff814a]">
            + Create new dashboard
          </button>
        </div>
      </div>

      <div className="hide-scrollbar flex gap-5 overflow-x-auto hide-scroll w-full p-5 px-0 mt-0  xl:grid grid-cols-5 ">
        {data.map((item, index) => {
          return (
            <div
              key={index}
