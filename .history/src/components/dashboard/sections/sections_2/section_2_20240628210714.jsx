...
const data = [
  ...
  { name: "TUE", UIUX: 20, BA: 35, Finance: 60, PM: 70 },
  { name: "WED", UIUX: 20, BA: 25, Finance: 40, PM: 80 },
  { name: "THU", UIUX: 20, BA: 35, Finance: 60, PM: 95 },
  { name: "FRI", UIUX: 20, BA: 25, Finance: 40, PM: 75 },
  { name: "SAT", UIUX: 20, BA: 60, Finance: 70, PM: 90 },
];
