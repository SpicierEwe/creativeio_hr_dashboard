...
export default function Section2() {
  return (
    <div className="flex flex-col lg:flex-row w-full gap-10  mt-7">
      {/* bar stats */}
      <div className="bg-primary p-2 rounded-2xl  lg:mx-0  ">
      ...
      <div className="bg-primary w-fit rounded-xl">
        <div className="flex flex-col lg:flex-row w-fit lg:w-full gap-3 lg:justify-between p-3  lg:p-7">
          <h2 className="font-bold">Employee Performance</h2>
          <button className="btn flex justify-between items-center gap-2 bg-accent_light p-1 px-2 rounded-lg w-fit">
            Week
            <RiArrowDropDownLine size={25} />
