...
export default function Section2() {
  return (
    <div className="bg-primary p-2 rounded-2xl w-fit  lg:mx-0 overflow-auto  mt-7 ">
      <div className="flex justify-between p-5">
        <h2>Employee Performance</h2>
        <button className="btn flex justify-between items-center gap-2 bg-accent_light p-1 px-2 rounded-full">
          Button
