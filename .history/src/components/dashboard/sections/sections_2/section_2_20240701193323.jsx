  ...
  return (
    <div className="flex flex-col 2xl:flex-row w-full  gap-10 mt-7 ">
      ...
      <div className="bg-primary p-2 rounded-2xl w-fit ">
        <div className="flex flex-col lg:flex-row gap-3 p-5 w-full  items-start justify-between bg-black">
          <div className="text-xl text-start flex flex-col gap-5  ">
            <h2 className="">Orders</h2>
            <h2 className="text-[#ff814a] text-3xl">189k</h2>
          </div>

          <button className="btn flex justify-between items-center gap-2 bg-accent_light p-1 pt-0.5 px-2 pr-0 rounded-lg w-fit">
            Week
            <RiArrowDropDownLine size={25} />
          </button>
        </div>
