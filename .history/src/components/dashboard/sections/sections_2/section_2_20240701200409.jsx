    ...
    <div className="flex flex-col 2xl:flex-row w-full  gap-4 mt-7 items-start ">
      ...
      Pie Chart
        ...
        <div className="bg-primary lg:w-fit rounded-xl w-full pl-5  ">
          ...
          {/* pie */}
          <div className="relative flex flex-col w-full xl:flex-row items-start xl:items-center pr-5">
            <CustomPieChart />
            <div className="flex flex-col text-start text-sm gap-9 p-5 px-0 whitespace-nowrap">
    ...
    <div className="text-white p-6 rounded-lg">
      ...
      <div className="timeline">
        {activities.map((activity, index) => (
          <div
            key={index}
            className="border-l-2 relative pl-5 border-l-red-500 pb-20 flex items-start"
          >
            <div className="w-5 h-5 absolute -left-[.7rem] border-[3px] top-0 bg-[#1c243f] border-[#ff814a]  rounded-full mt-1.5 mr-3"></div>
            <div className="">
              <p className="text-md">
