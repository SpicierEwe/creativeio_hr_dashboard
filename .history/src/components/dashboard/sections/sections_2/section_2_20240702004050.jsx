    ...
    <div className="flex flex-col 2xl:flex-row w-full  gap-4 mt-7 items-start ">
      ...
      Pie Chart
        =========================*/}
          ...
          <div className="bg-primary p-2 rounded-2xl w-fit ">
            <div className="flex flex-col lg:flex-row gap-3 p-5 w-full  items-start justify-between">
              <div className="text-xl text-start flex flex-col gap-3  ">
        ...
        <div className="flex flex-col 2xl:flex-row gap-4  ">
          ...
          {/* double chart */}
          <div className="flex flex-col xl:flex-row w-full bg-primary rounded-xl">
            <div className=" p-7 w-[20rem] lg:w-full hide-scrollbar overflow-x-auto">
              <DoubleBarChart />
            </div>

            {/* c-2  */}
            <div className="w-full xl:w-[50%] flex flex-col gap-5 justify-around items-center  py-5 xl:border-l-2 border-t-2 border-t-[#273c6a] pt-10 xl:border-l-[#273c6a]">
