      ...
      Pie Chart
        ...
        <div className="flex flex-col 2xl:flex-row gap-4  ">
          ...
          <div className="flex w-full bg-primary">
            ...
            {/* c-2  */}
            <div className=" w-full flex flex-col justify-around justify-center py-5">
              <button className="flex items-center gap-3 h-fit border border-[#0bb885] p-1 px-3 rounded-lg">
                <p>2020</p>
                <MdOutlineKeyboardArrowDown />
              </button>
              <div>
                <h2 className="font-bold">$842.98</h2>
              </div>
              <div>
                <h2 className="font-bold">$842.98</h2>
              </div>
