      ...
      Pie Chart
        ...
        <div className="flex flex-col 2xl:flex-row gap-4  ">
          ...
          <div className="flex flex-col xl:flex-row w-full bg-primary rounded-xl">
            ...
            {/* c-2  */}
            <div className="w-full xl:w-[50%] flex flex-col justify-around items-center  py-5 border-l-2 border-l-[#273c6a]">
              <button className="flex gap-5  items-center gap-3 w-fit border border-[#0bb885] p-1 px-3 rounded-lg">
                <p>2020</p>
