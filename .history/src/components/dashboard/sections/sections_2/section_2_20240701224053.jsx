      ...
      Pie Chart
        ...
        <div className="flex flex-col 2xl:flex-row gap-4  ">
          ...
          <div className="flex w-full bg-primary">
            ...
            {/* c-2  */}
            <div className="border-l-2 border-l-red-300 justify-center w-full py-5">
              <div>
                <button className="flex items-center gap-3 justify-center border border-[#0bb885] p-1 px-3 rounded-lg">
                  <p>2020</p>
