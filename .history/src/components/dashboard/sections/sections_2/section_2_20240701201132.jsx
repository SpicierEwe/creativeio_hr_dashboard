    ...
    <div className="p-6 rounded-lg">
      ...
      <div className="timeline">
        {activities.map((activity, index) => (
          <div
            key={index}
            className="border-l-2 relative pl-5 border-l-red-500 pb-20 flex items-start bg-black"
          >
            <div className="w-5 h-5 absolute -left-[.7rem] border-[3px] -top-1  bg-[#1c243f] border-[#ff814a]  rounded-full mt-1.5 mr-3"></div>
            <div className="">
              <p className="text-md">
