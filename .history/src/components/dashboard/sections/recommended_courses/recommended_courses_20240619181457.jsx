...
const RecommendedCourses = () => {
  return (
    <div className="items-start bg-white rounded-xl text-start">
      ...
      <div className="mt-10 w-full flex gap-5 overflow-x-auto px-15">
        {coursesData.map((course) => (
          <div className=" rounded-2xl flex flex-col    items-center gap-4  text-start justify-between  ">
            {/* container 1 === */}
