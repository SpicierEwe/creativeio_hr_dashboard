    ...
    <div className="lg:pr-12 pb-9 pt-10 ml-20 xl:ml-56 ">
      ...
      <div className="text-start mt-10 p-8 bg-white min-h-screen ">
        ...
        <section className="mb-8 text-start ">
          ...
          <ul className="list-disc pl-5 mb-4 text-start">
            <li>
        ...
        <section className="flex justify-around mb-8 mt-20 mb-10">
        ...
        <section className="p-8 text-center max-w-screen-md mx-auto">
          ...
          <form className="mt-10">
            <div className="mb-4">
              ...
              <select
                id="service"
                className="mt-5 block w-full border-gray-300 rounded-md shadow-md border p-5 pr-10"
              >
