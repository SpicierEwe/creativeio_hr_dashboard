  ...
  return (
    <div className="lg:pr-12 pb-9 pt-10 ml-20 xl:ml-56 ">
      <div className="xl:px-10 ">
        ...
        {/*  */}
        <div className="text-start mt-14 p-8 bg-white min-h-screen text-[#abafb3] ">
          ...
          <section className="flex flex-col xl:flex-row justify-around max-w-screen-lg mx-auto  gap-10 mt-20 mb-10">
          ...
          <section className="p-8 text-center max-w-screen-md mx-auto mt-20">
            ...
            <form className="mt-10">
              <div className="mb-4">
                <select
                  id="service"
                  className="mt-5 block w-full bg-white border-gray-300 rounded-md  border p-5"
                >
              ...
              <div className="mb-4 text-start">
                ...
                <textarea
                  id="comment"
                  className="mt-3 block w-full border border-gray-300 bg-white rounded-md shadow-sm"
                  rows="7"
                ></textarea>
              </div>
              <button
