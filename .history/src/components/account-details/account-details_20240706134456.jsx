function AccountDetails() {
  return (
    <div className="lg:pr-12 pb-9 pt-10 ml-20 xl:ml-56 ">
      ...
      {/*  */}
      <div className="text-start mt-10 p-8 bg-white min-h-screen ">
        ...
        <section className="mb-8 text-start ">
          <p className="mb-4">
            ...
            At Creativo our dolor sit amet, consetetur sadipscing elitr, sed
            diam nonu eirmod tempor invidunt ut labore et dolore magna aliquyam
            erat, sed di voluptua. At vero eos et accusam et justo duo dolores
            et ea rebum. Stet clita kasd gubergren, Creativo sanctus est Lorem
