...
const TopNavBar = () => {
  ...
  return (
    <div className="flex  justify-end xl:justify-between w-full  bg-primary w-screen fixed max-w-screen-2xl p-2 py-[.875rem] border-b-[.5px] border-gray-200 xl:px-10 ">
      <div className="flex   bg-red-50 items-center xl:ml-56  ">
        {/* search  box */}
