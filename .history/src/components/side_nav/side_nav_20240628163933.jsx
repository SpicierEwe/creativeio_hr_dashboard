...
function SideNav() {
  ...
  return (
    <div className="fixed">
      <TopNavBar />
      <ul className="flex flex-col fixed  gap-3 h-screen  w-fit p-1 pl-3 pr-0 justify-between z-[999] bg-primary">
            ...
            return (
              <Link to={item.redirect}>
                <li
                  key={item.id}
                  // bg
                  className={`p-2  text-md cursor-pointer rounded-xl w-fit md:mid-full ${
