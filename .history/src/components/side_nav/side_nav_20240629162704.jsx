...
const TopNavBar = () => {
  ...
  return (
    <div className="flex  justify-end xl:justify-between  bg-primary w-screen fixed max-w-screen-2xl p-2 py-[.875rem] border-b-[.5px] border-gray-200 xl:px-10 ">
      <div className="flex   justify-end xl:justify-between items-center xl:ml-56  ">
        {/* search  box */}
        <label className="hidden input input-bordered xl:flex items-center gap-2">
          <svg
