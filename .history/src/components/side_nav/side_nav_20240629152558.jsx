...
function SideNav() {
  ...
  const [selectedNav2Index, setSelectedNav2Index] = useState(0);
        ...
        <div className="flex flex-col  gap-3">
          ...
          <div className="mt-2">
            {menu2.map((item, index) => {
              const isSelected = selectedNav2Index === index;
              return (
                <Link to={item.redirect}>
                  <li
                    key={item.id}
                    ...
                    onClick={() => setSelectedNav2Index(index)}
                  >
                    <div className="flex justify-between gap-10 ">
                      <div className="flex gap-4">
                        {/* item icon */}
