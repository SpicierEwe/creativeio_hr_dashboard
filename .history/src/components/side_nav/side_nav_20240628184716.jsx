...
function SideNav() {
  ...
  return (
    <div className="fixed">
      {/* top nav */}
      <TopNavBar />
      <ul className="flex flex-col fixed  gap-3 h-screen  p-1 pl-3 pr-0 justify-between z-[999] bg-primary lg:w-[17%]">
            ...
            return (
              <Link to={item.redirect}>
                <li
                  key={item.id}
                  // bg
                  className={`p-2 border-r-2 border-accent  text-md cursor-pointer w-full ${
