...
function SideNav() {
  ...
  return (
    <div className="fixed max-w-screen-2xl">
      {/* top nav */}
      <TopNavBar />
      <ul className="flex flex-col fixed  gap-3 h-screen justify-between z-[999] bg-primary w-fit ">
            ...
            return (
              <Link to={item.redirect}>
                <li
                  key={item.id}
                  // bg
                  className={`p-3 border-r-2 lg:pr-[7rem] ${
