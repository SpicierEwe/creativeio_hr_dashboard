...
const TopNavBar = () => {
  ...
  return (
    <div className="bg-primary w-screen fixed max-w-screen-2xl p-2 py-[.875rem] border-b-[.5px] border-gray-200 xl:px-10">
      {/* mobile */}
      <div className="flex justify-end items-center">
        ...
        <div className="flex gap-3">
          {icons.map((icon, index) => (
            <div
              key={index}
              className="flex justify-end p-2  text-accent bg-accent_light rounded-lg text-md xl:text-xl"
            >
              {icon}
            </div>
          ))}
        </div>
        <div className="w-7 h-7 ml-3 aspect-square overflow-hidden">
          <img
