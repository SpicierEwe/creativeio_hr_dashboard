...
const TopNavBar = () => {
  ...
  return (
    <div className="flex  justify-end xl:justify-between w-full  bg-primary fixed max-w-screen-2xl p-2 xl:py-[.7rem] py-[1rem] border-b-[.5px] border-gray-200 xl:px-10 ">
