        ...
        <div className="flex items-center">
          <div className="flex gap-3 items-center">
            ...
            <details className="dropdown bg-white">
              ...
              <ul className="menu dropdown-content bg-white  z-[1] w-[20rem] p-2 shadow mt-4 right-0">
                {notifications.map((data, index) => {
                  return (
                    <li>
                      <div className="flex gap-5 items-center">
                        <div className="bg-pink-200 p-5 rounded-full">
                          <IoPerson size={22} className="  text-red-400 p-5 " />
                        </div>
            ...
            <details className="dropdown bg-white">
              ...
              <ul className="menu dropdown-content bg-white  z-[1] w-52 p-2 shadow mt-4">
                <li>
                  <a>My Profile</a>
                </li>
                <li>
